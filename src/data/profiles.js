...
// Admin profiles
const ADMIN_PROFILES = ['en/us', 'en/ca', 'fr/ca', 'en/uk', 'pt/br', 'de/de', 'fr/fr', 'ja/jp'];

// Profiles WITHOUT IMM banner
const NO_IMM = ['ko/kr', 'zh/hk', 'en/hk', 'zh/tw'];

// Profiles WITH FAQ
const HAS_FAQ = ['en/us', 'en/ca', 'fr/ca', 'en/uk', 'ja/jp'];
...
export const profiles = PROFILE_ORDER.map((id) => ({
  id,
  slug: profileToSlug(id),
  isAdmin: ADMIN_PROFILES.includes(id),
  hasIMM: !NO_IMM.includes(id),
  hasFAQ: HAS_FAQ.includes(id),
